   ...
   // else{
      //  if($image_size==FALSE)
       ...
       // else{
        ...
        if(!$insert=mysqli_query($con,"INSERT INTO news (Content,Image,Title,Content_SRB,Title_SRB, Title_GER,Content_GER) VALUES ('$content','$image','$title','$content_srb','$title_srb','$title_de','$title_de')")){
            echo mysql_error();
